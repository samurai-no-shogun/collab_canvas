...
function __wbg_adapter_10(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd2ab20f10f0f4be5(arg0, arg1, addHeapObject(arg2));
}
    ...
    */
    update_pixel(x, y, color) {
        try {
            ...
            wasm.canvas_update_pixel(retptr, this.__wbg_ptr, x, y, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('collaboration_canvas_client_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
